...
class UpdateAnimalDetails extends StatefulWidget {
  final int animalId;
  const UpdateAnimalDetails({super.key, required this.animalId});

  @override
  State<UpdateAnimalDetails> createState() => _UpdateAnimalDetails();
}

class _UpdateAnimalDetails extends State<UpdateAnimalDetails> {
